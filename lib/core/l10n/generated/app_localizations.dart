...
abstract class AppLocalizations {
  ...
  /// No description provided for @menu_orders.
  ///
  /// In en, this message translates to:
  /// **'Orders'**
  String get menu_orders;

  /// No description provided for @menu_transaction.
  ///
  /// In en, this message translates to:
  /// **'Transaction'**
  String get menu_transaction;

  /// No description provided for @menu_store.
  ///
  /// In en, this message translates to:
  /// **'Store'**
  String get menu_store;

  /// No description provided for @menu_users.
  ///
  /// In en, this message translates to:
  /// **'Users'**
  String get menu_users;
