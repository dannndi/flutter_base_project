...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( Locale current)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LanguageState() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( Locale current)  $default,) {final _that = this;
switch (_that) {
case _LanguageState():
return $default(_that.current);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( Locale current)?  $default,) {final _that = this;
switch (_that) {
case _LanguageState() when $default != null:
return $default(_that.current);case _:
  return null;
...
class _LanguageState extends LanguageState {
   _LanguageState({this.current = const Locale("en")}): super._();
  

@override@JsonKey() final  Locale current;
