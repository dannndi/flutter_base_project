...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ThemeState&&(identical(other.current, current) || other.current == current));
}
...
@override
String toString() {
  return 'ThemeState(current: $current)';
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( ThemeMode current)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ThemeState() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( ThemeMode current)  $default,) {final _that = this;
switch (_that) {
case _ThemeState():
return $default(_that.current);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( ThemeMode current)?  $default,) {final _that = this;
switch (_that) {
case _ThemeState() when $default != null:
return $default(_that.current);case _:
  return null;
...
class _ThemeState extends ThemeState {
   _ThemeState({this.current = ThemeMode.system}): super._();
  

@override@JsonKey() final  ThemeMode current;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ThemeState&&(identical(other.current, current) || other.current == current));
}
